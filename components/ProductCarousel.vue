  ...
  data() {
    return {
      products: [
        ...
        {
          title: "Granola",
          image: require("~/assets/soaps/handgemachte-seife-granola.jpg"),
        ...
        {
          title: "Eucalypta",
          image: require("~/assets/soaps/handgemachte-seife-eucalypta.jpg"),
        ...
        {
          title: "Camouflage",
          image: require("~/assets/soaps/handgemachte-seife-camouflage.jpg"),
          alt:
